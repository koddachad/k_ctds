...
:py:meth:`k_ctds.Cursor.execute()` or :py:meth:`k_ctds.Cursor.callproc()`.
...
:py:meth:`k_ctds.Cursor.fetchone()`, :py:meth:`k_ctds.Cursor.fetchmany()`, or
:py:meth:`k_ctds.Cursor.fetchall()` methods. *cTDS* will cache all retrieved raw
...
retrieved using the :py:attr:`k_ctds.Cursor.description` property.
...
The row list returned from :py:meth:`k_ctds.Cursor.fetchmany()`, or
:py:meth:`k_ctds.Cursor.fetchall()` implements the Python sequence protocol and
...
.. note::
    ...
    recommended to use :py:meth:`k_ctds.Cursor.fetchall()` to retrieve all the
    ...
    :py:meth:`k_ctds.Cursor.fetchone()` or :py:meth:`k_ctds.Cursor.fetchmany()`.
...
The result set can be advanced using the :py:meth:`k_ctds.Cursor.nextset()`
method. New operations using :py:meth:`k_ctds.Cursor.execute()` or
:py:meth:`k_ctds.Cursor.callproc()` will discard any unread result sets.
